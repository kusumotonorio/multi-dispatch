...
memory mm5 namespaces prettyprint quotations sequences
...
! USING: math.order sorting.slots ;
! men get dup cartesian-product concat >array
! [ hashcode-test ] map { <=> } sort-by .

V{ } clone
0 100 [a,b] dup cartesian-product concat dup length -rot
[ hashcode-test ] map
[ over adjoin ] each length swap / 100.0 * "unique hashcode: %6.2f%% \n" printf
